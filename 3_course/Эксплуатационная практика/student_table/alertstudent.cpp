    ...
    ui(new Ui::AlertStudent)
{
    ...
    connect(ui->alert, SIGNAL(clicked()), this, SLOT(on_alert_clicked()));
}
...
void AlertStudent::studentAlert(QStringList alertStud)
{
    ...
    QFile json;
//    json.setFileName("C://Users//Lapte//Documents//alertStudent.json");
    json.setFileName("/home/admin1/alertStudent.json");
...
{
    QFile *askAlertStud = new QFile ("/home/admin1/alertStudent.json");
//    QFile *askAlertStud = new QFile ("C://Users//Lapte//Documents//alertStud.json");
