...
void DeleteStudent::studentDelete(QStringList deleteStud)
{
    ...
    QFile json;
//    json.setFileName("C://Users//Lapte//Documents//deleteStudent.json");
    json.setFileName("/home/admin1/deleteStudent.json");
...
{
    QFile *askDelStud = new QFile ("/home/admin1/deleteStudent.json");
